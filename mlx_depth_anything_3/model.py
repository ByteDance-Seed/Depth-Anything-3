...
MODEL_CONFIGS = {
    ...
    "da3-large": dict(
        backbone=dict(name="vitl", out_layers=[11, 15, 19, 23], alt_start=4,
                      qknorm_start=4, rope_start=4, cat_token=True),
    ...
    "da3-giant": dict(
        backbone=dict(name="vitg", out_layers=[19, 25, 31, 39], alt_start=4,
                      qknorm_start=4, rope_start=4, cat_token=True),
        head=dict(dim_in=3072, output_dim=2, features=384,
                  out_channels=[384, 768, 1536, 1536]),
